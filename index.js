...
const API_TOKEN="496154640:AAHxzqJIYglX6yVxArS4PpYpOFKongtFqlU";
const URL = process.env.URL || 'https://guarded-sands-12822.herokuapp.com/'
...
setInterval(function() {
    http.get("http://guarded-sands-12822.herokuapp.com");
...
bot.hears('Albe', (ctx)=>ctx.reply("nabbo"))
bot.hears('Alce', (ctx)=>ctx.reply("gay"))
